...
@EventBusSubscriber
public class AharthernForestTrunkDecorator extends TrunkVineDecorator {

	public static MapCodec<AharthernForestTrunkDecorator> CODEC = MapCodec.unit(AharthernForestTrunkDecorator::new);

	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("misfitcraft:aharthern_forest_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
