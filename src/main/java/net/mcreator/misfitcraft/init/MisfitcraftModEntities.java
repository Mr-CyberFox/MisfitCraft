...
@EventBusSubscriber
public class MisfitcraftModEntities {
	public static final DeferredRegister<EntityType<?>> REGISTRY = DeferredRegister.create(Registries.ENTITY_TYPE, MisfitcraftMod.MODID);
