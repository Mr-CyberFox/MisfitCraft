package net.mcreator.misfitcraft;
...
@Mod("misfitcraft")
public class MisfitcraftMod {
	public static final Logger LOGGER = LogManager.getLogger(MisfitcraftMod.class);
	public static final String MODID = "misfitcraft";

	public MisfitcraftMod(IEventBus modEventBus) {
