...
public class RaceGUIselectProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof Player _plr0 && _plr0.containerMenu instanceof RaceGUIMenu) {
			...
			if (entity instanceof Player _plr5 && _plr5.containerMenu instanceof RaceGUIHumanMenu) {
				...
				if (entity instanceof Player _plr10 && _plr10.containerMenu instanceof RaceGUISpiritMenu) {
					...
					if (entity instanceof Player _plr15 && _plr15.containerMenu instanceof RaceGUIDraconidMenu) {
