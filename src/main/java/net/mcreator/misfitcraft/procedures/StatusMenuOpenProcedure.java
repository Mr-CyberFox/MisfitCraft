...
public class StatusMenuOpenProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (!(entity instanceof Player _plr0 && _plr0.containerMenu instanceof StatusMenuMenu)) {
			if (entity instanceof ServerPlayer _ent) {
				BlockPos _bpos = BlockPos.containing(x, y, z);
				_ent.openMenu(new MenuProvider() {
					@Override
					public Component getDisplayName() {
						return Component.literal("StatusMenu");
					}
		...
		if (entity instanceof Player _plr2 && _plr2.containerMenu instanceof StatusMenuMenu) {
