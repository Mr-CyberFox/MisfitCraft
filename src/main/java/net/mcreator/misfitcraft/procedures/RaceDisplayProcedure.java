	...
	public static String execute(Entity entity) {
		...
		if ((entity instanceof LivingEntity _livingEntity0 && _livingEntity0.getAttributes().hasAttribute(MisfitcraftModAttributes.RACE) ? _livingEntity0.getAttribute(MisfitcraftModAttributes.RACE).getBaseValue() : 0) == 0) {
			...
			return "Demon               Demon Royal         Mythical Era Demon  Misfit              ".substring(
					(int) (((entity instanceof LivingEntity _livingEntity3 && _livingEntity3.getAttributes().hasAttribute(MisfitcraftModAttributes.RACE) ? _livingEntity3.getAttribute(MisfitcraftModAttributes.RACE).getBaseValue() : 0) - 1) * 20),
					(int) (((entity instanceof LivingEntity _livingEntity4 && _livingEntity4.getAttributes().hasAttribute(MisfitcraftModAttributes.RACE) ? _livingEntity4.getAttribute(MisfitcraftModAttributes.RACE).getBaseValue() : 0) - 1) * 20
							+ 20));
			...
			return "Human         Hero Student  Hero          Legendary Hero".substring(
					(int) (((entity instanceof LivingEntity _livingEntity7 && _livingEntity7.getAttributes().hasAttribute(MisfitcraftModAttributes.RACE) ? _livingEntity7.getAttribute(MisfitcraftModAttributes.RACE).getBaseValue() : 0) - 5) * 14),
					(int) (((entity instanceof LivingEntity _livingEntity8 && _livingEntity8.getAttributes().hasAttribute(MisfitcraftModAttributes.RACE) ? _livingEntity8.getAttribute(MisfitcraftModAttributes.RACE).getBaseValue() : 0) - 5) * 14
							+ 14));
			...
			return "Half Spirit Spirit      Great Spirit".substring(
					(int) (((entity instanceof LivingEntity _livingEntity11 && _livingEntity11.getAttributes().hasAttribute(MisfitcraftModAttributes.RACE) ? _livingEntity11.getAttribute(MisfitcraftModAttributes.RACE).getBaseValue() : 0) - 9) * 12),
					(int) (((entity instanceof LivingEntity _livingEntity12 && _livingEntity12.getAttributes().hasAttribute(MisfitcraftModAttributes.RACE) ? _livingEntity12.getAttribute(MisfitcraftModAttributes.RACE).getBaseValue() : 0) - 9) * 12
							+ 12));
			...
			return "Draconid      Draconid SaintDraconid Pope Dragonborn    ".substring(
					(int) (((entity instanceof LivingEntity _livingEntity15 && _livingEntity15.getAttributes().hasAttribute(MisfitcraftModAttributes.RACE) ? _livingEntity15.getAttribute(MisfitcraftModAttributes.RACE).getBaseValue() : 0) - 12) * 14),
					(int) (((entity instanceof LivingEntity _livingEntity16 && _livingEntity16.getAttributes().hasAttribute(MisfitcraftModAttributes.RACE) ? _livingEntity16.getAttribute(MisfitcraftModAttributes.RACE).getBaseValue() : 0) - 12) * 14
							+ 14));
			...
			return "Keeper   God      Chief God".substring(
					(int) (((entity instanceof LivingEntity _livingEntity19 && _livingEntity19.getAttributes().hasAttribute(MisfitcraftModAttributes.RACE) ? _livingEntity19.getAttribute(MisfitcraftModAttributes.RACE).getBaseValue() : 0) - 16) * 9),
					(int) (((entity instanceof LivingEntity _livingEntity20 && _livingEntity20.getAttributes().hasAttribute(MisfitcraftModAttributes.RACE) ? _livingEntity20.getAttribute(MisfitcraftModAttributes.RACE).getBaseValue() : 0) - 16) * 9
							+ 9));
		}
		return "ERROR 404";
	}
